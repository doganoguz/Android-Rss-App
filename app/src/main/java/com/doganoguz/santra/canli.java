...
public class canli extends AppCompatActivity {
    private WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_canli);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                webView.loadUrl("http://www.doganoguz.96.lt/canli.html");
            }
        });
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(this, "Santra",
                "Canlı Sonuçlar Yükleniyor...", true);
